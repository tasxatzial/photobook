    ...
    <div id="signup">
      <div id="signup-step1">
        ...
        <div class="sign-child">
          ...
          <input type="text" class="sign-tofill" value="<%= (String) request.getAttribute("username")%>" name="signup-username" id="signup-username" pattern="^[A-Za-z]{8,25}$" required>
          <p class="signup-require-info">8 to 25 characters, only letters</p>
        </div>
